        ...
        {orders.map((order) => (
          <li key={order._id} className="p-4 border border-gray-700 rounded-lg bg-gray-800 shadow-md">
            ...
            <div className="bg-gray-800 p-4 rounded-md shadow-md">
                          ...
                          <li key={beat._id} className="relative p-4 border border-gray-600 rounded-lg bg-gray-700 shadow-lg">
                            ...
                            <div className="text-center space-y-2">
                              ...
                              <div className="text-sm space-y-1">
                                ...
                                <p><strong className="text-gray-400">Tone:</strong> {beat.tone}</p>
              ...
              <p className="grid grid-cols-2 items-center justify-items-stretch">
                ...
                <div className="grid grid-cols-2 items-center justify-items-stretch">
                  {/* Price Display */}
                  <p className="font-extrabold text-3xl md:text-4xl text-teal-400 mt-2 mb-2 justify-self-start">
                    ${order.price}
                  </p>
                  ...
                  <button 
                    ...
                    className={`bg-teal-700 text-white text-lg px-4 py-2 rounded-lg 
                      ...
                      duration-300 transform hover:scale-110 justify-self-end ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                    disabled={loading}
                  > 
                    {loading ? (
                      <Loading />
