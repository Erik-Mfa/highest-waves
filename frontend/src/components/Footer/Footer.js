...
const Footer = () => {
  return (
    <footer className="text-white pt-20 bg-brown">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row gap-12 md:gap-16">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs my-10 text-slate-400">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs my-10 text-slate-400">&copy; 2024 Highest Waves. All rights reserved.</p>
          </div>
        </div>

        {/* Reach Us Section */}
        <div className="flex flex-col items-center md:items-start mt-12">
          <h2 className="text-3xl font-bold mb-6 text-slate-200">Reach Us</h2>
        ...
        <div className="py-6 text-sm mt-24 text-slate-400">
