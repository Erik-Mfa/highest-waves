  ...
  <div className="container mx-auto px-6 md:px-12">
    <div className="flex flex-col md:flex-row gap-12 md:gap-16">
      ...
      <div className="flex-1">
        <h2 className="text-3xl font-bold mb-4">Privacy & Data Security</h2>
      ...
      <div className="flex-1">
        <h2 className="text-3xl font-bold mb-4">About Highest Waves</h2>
        <p className="text-md mb-4">
      ...
      <div className="flex-1 flex flex-col items-center md:items-start">
        ...
        <p className="text-md mb-6">
          Stay updated with our latest news, exclusive offers, and new beat releases by following us in the social media.
        </p>
